...
**定番FTPクライアントソフトWinSCPのエクステンション**としてワンタッチインストールでお手軽にちゃちゃっと  
環境構築を作ることができWinSCPを介して通信を行うためセキュアで安全にファイル管理が行えます。  
（決して新人社員が間違ってクローズドソースをネットに晒してしまうよう事故を未然に防ぐことができます。）    
開発ツールが十分に準備されていない、または~~上司に圧力を掛けられて炎上した~~十分に予算を掛けられないプロジェクト  
超短期スケジュールでとにかく人手も時間も無くてやむなく~~こんな糞ツール~~に頼らざるを得ない
。。。などといったあらゆる~~過酷な現場~~ 開発シーンでの活躍をサポートできます。
...
4. 拡張機能の追加画面のURLにコピーしたGitHubの[Rawリンク]  
...
----|----|---- 
|work_dir|リポジトリを保存するディレクトリパスが入ります|C:\Users\USER\.shchk\|
